...
import com.example.servingwebcontent.controller.MainController;
...
@TestPropertySource({"/application-test.properties", "/emailSender.properties"})
...
public class MainControllerTest {
    ...
    public void filterMessageTest() throws Exception {
        mockMvc.perform(get("/main").param("filter", "same-text"))
                .andDo(print())
                .andExpect(authenticated())
    ...
    public void addMessageToListTest() throws Exception {
        ...
        mockMvc.perform(multipart)
                ...
                .andExpect(xpath("//div[@id='message-list']/div/div[@id='10']").exists())
                .andExpect(xpath("//div[@id='message-list']/div/div[@id='10']/div/span").string("fifth"))
                .andExpect(xpath("//div[@id='message-list']/div/div[@id='10']/div/i").string("#new text"));
    }
}
